...
public class LiveData {
    ...
    private static String auth = "297c97af30abc0eee9f889a94d238fb42dbe0b4cdc42982affd4aa44a49f18cb";
    ...
    private static int loadUpdateHandlers() throws Exception {
        ...
        for (Class<? extends LiveDataUpdateHandler> c : PackageLoader.load("io.ruin.services.livedata.handler.impl", LiveDataUpdateHandler.class, false)) {
            try {
                ...
                System.err.println("Failed to load live data update handler: " + c.getName());
                e.printStackTrace();
            }
        }
        return loaded;
