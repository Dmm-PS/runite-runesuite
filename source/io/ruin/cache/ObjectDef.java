...
public class ObjectDef {
    ...
    public static ObjectDef[] LOADED_EXTRA = new ObjectDef[11];
    ...
    private void decode(InBuffer in) {
        ...
        if (id == 18258) {
            ...
            //uhh i hope 31378 isn't ever used
            name = "Portal";
            type22Int = 1;
            unknownOpcode24 = 7304;
            unknownOpcode_78_79= 3;
            tall = false;
            options = new String[] { "Enter", "Home", "Build mode", "Friend's house", null };
            clipType = 1;
            type22Boolean = false;
            showIds = null;
            modelIds = new int[] { 11242, 11234 };
            yLength = 2;
            xLength = 2;
            unknownOpcode78 = 3139;
            unknownOpcode29 = 40;
            varpId = -1;
        } else if (id == 30395) {
