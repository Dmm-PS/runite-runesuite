...
public class CombatUtils {
    ...
    public static void addXp(Player player, Entity victim, AttackStyle attackStyle, AttackType attackType, int damageDealt) {
        ...
        // Quick fix for PVP world combat dummy's not giving experience drops
        if (victim.npc != null && victim.npc.getId() == 2668) {
            return;
        }
        if (multiplier && (!World.isPVP() && victim.npc.getId() == 2668))
