...
public class RougesCastle {
    ...
    public static final LootTable ECO_TABLE = new LootTable().addTable(1,
            ...
            new LootItem(995, 1500, 5000, 100),      //1500-5000 coins
    ...
    public static final LootTable PVP_TABLE = new LootTable().addTable(1,
                    new LootItem(13307, 50, 100, 4), //Blood money
                    new LootItem(13307, 80, 175, 3), //Blood money
                    new LootItem(13307, 100, 250, 2), //Blood money
                    new LootItem(13307, 250, 400, 1), //Blood money
    ...
    private static void openChest(Player player) {
        if(player.getCombat().getLevel() != 126 && World.isPVP()) {
            player.sendMessage("You have to be level 126 combat to open this chest!");
            return;
        }
    ...
    private static void searchForTraps(Player player, GameObject chest) {
        ...
        if (World.isEco() && !player.getStats().check(StatType.Thieving, 84, "successfully loot this chest"))
            return;
        player.startEvent(event -> {
            ...
            player.animate(535);
            player.getInventory().add(World.isPVP() ? PVP_TABLE.rollItem() : ECO_TABLE.rollItem());
