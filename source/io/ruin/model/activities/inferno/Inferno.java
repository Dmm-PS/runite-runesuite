            ...
            if(lastWave == 0) {
                ...
                if(!killedZuk) {
                    ...
                    if(World.isEco())
                        ...
                        player.getInventory().addOrDrop(13307, 4000);
        ...
        ObjectAction.register(30352, actions -> {
            actions[1] = (player, obj) -> {
                player.dialogue(new OptionsDialogue(
                        new Option("Enter the Inferno", () -> join(player, World.isPVP() ? 67 : getStartingWave(player), false)),
                        new Option("Practice a specific wave", () -> {
                            player.integerInput("Enter the wave you'd like to practice: (1-69)", wave -> {
                                if(wave < 0 || wave > 69) {
