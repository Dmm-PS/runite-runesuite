...
public class PVPInstance {
    ...
    private static boolean allowAttack(Player player, Player pTarget, boolean message) {
        ...
        SpellBook book = SpellBook.values()[Config.MAGIC_BOOK.get(player)];
        if (!book.isActive(pTarget)) {
            if (message)
                player.sendMessage("You can only attack players that are using the same spellbook as you in PvP instances.");
            return false;
        }
        return true;
    }
    ...
    public static void init(List<Region> emptyRegions) {
        ...
        spawnNpc(camelot, 315, 2757, 3481, 0, Direction.SOUTH, 0); //rustin
        spawnNpc(camelot, 4159, 2758, 3481, 0, Direction.SOUTH, 0); //wizard
        spawnNpc(camelot, 535, 2759, 3481, 0, Direction.SOUTH, 0); //horvik
        spawnObj(camelot, 2693, 2755, 3479, 0, 10, 1); //bank chest
        removeObj(camelot, 576, 2756, 3481, 0); //statue on horvik tile
        removeObj(camelot, 576, 2759, 3481, 0); //statue on rustin tile
        ...
        spawnObj(edgeville, 7409, 3094, 3501, 0, 10, 1); //bank chest
        spawnObj(edgeville, 7409, 3094, 3502, 0, 10, 1); //bank chest
        spawnObj(edgeville, 7409, 3094, 3503, 0, 10, 1); //bank chest
        spawnObj(edgeville, 7409, 3094, 3504, 0, 10, 1); //bank chest
        spawnObj(edgeville, 7409, 3094, 3505, 0, 10, 1); //bank chest
        spawnObj(edgeville, 7409, 3094, 3506, 0, 10, 1); //bank chest


        spawnNpc(edgeville, 397, 3099, 3492, 0,Direction.WEST, 0);// Banker
        spawnNpc(edgeville, 395,3099, 3494, 0, Direction.WEST, 0); // Banker
        spawnNpc(edgeville, 394,3099, 3496, 0, Direction.WEST, 0); // Banker
        spawnNpc(edgeville, 395,3099, 3498, 0, Direction.WEST, 0); // Banker
        spawnNpc(edgeville, 396,3099, 3500, 0, Direction.WEST, 0); // Banker
        spawnNpc(edgeville, 394,3100, 3500, 0, Direction.NORTH, 0); // Banker
        spawnNpc(edgeville, 397,3102, 3500, 0, Direction.NORTH, 0); // Banker


        register(edgeville, "Edgeville", 3094, 3497, 3095, 3497, new Bounds(3095, 3491, 3202, 3506, 0) //bank
        );
        /**
         * Falador
         */
        ...
        spawnNpc(falador, 315, 2943, 3371, 0, Direction.EAST, 0); //rustin
        spawnNpc(falador, 4159, 2943, 3370, 0, Direction.EAST, 0); //wizard
        spawnNpc(falador, 535, 2943, 3369, 0, Direction.EAST, 0); //horvik
        register(
                falador, "Falador",
                2947, 3371, 2946, 3371,
        ...
        spawnNpc(lumbridge, 315, 3221, 3218, 0, Direction.EAST, 0); //rustin
        spawnNpc(lumbridge, 4159, 3221, 3219, 0, Direction.EAST, 0); //wizard
        spawnNpc(lumbridge, 535, 3221, 3220, 0, Direction.EAST, 0); //horvik
