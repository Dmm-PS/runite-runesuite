...
public class FightCaves {
    ...
    static {
        ...
        ObjectAction.register(11833, actions -> {
            actions[1] = (player, obj) -> join(player, World.isPVP() ? 31 : getStartingWave(player), false);
            actions[2] = (player, obj) -> {
                player.integerInput("Enter the wave you'd like to practice: (1-63)", wave -> {
                    if(wave < 0 || wave > 63) {
