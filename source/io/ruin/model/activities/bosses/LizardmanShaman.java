...
public class LizardmanShaman extends NPCCombat {
    ...
    private static final Projectile ACIDIC_PROJECTILE = new Projectile(1293, 105, 1, 61, 60, 10, 30, 128);
    ...
    private void jumpAttack() {
        ...
        npc.startEvent(event -> {
            Position destination = target.getPosition().copy().translate(-1, -1, 0);
