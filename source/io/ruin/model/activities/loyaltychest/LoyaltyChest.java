...
public class LoyaltyChest {
    ...
    private static final Item[] ECO_REWARDS = {
            ...
            new Item(995, 150_000),
            new Item(995, 200_000),
            new Item(995, 500_000),
            new Item(995, 750_000),
            new Item(995, 1_000_000),
            new Item(995, 1_500_000),
    ...
    private static void openChest(Player player) {
        ...
        Item[] rewards = World.isPVP() ? PVP_REWARDS : ECO_REWARDS;
        player.getPacketSender().sendLoyaltyRewards(player.loyaltyChestReward, player.loyaltyChestSpree, player.highestLoyaltyChestSpree, PlayerCounter.LOYALTY_CHEST_OPENED.get(player), rewards);
    }
    ...
    private static void claimReward(Player player, int requestedDayReward) {
        ...
        player.startEvent(event -> {
            ...
            giveReward(player);
            PlayerCounter.LOYALTY_CHEST_OPENED.increment(player, 1);
