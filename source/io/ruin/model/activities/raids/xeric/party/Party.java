...
public class Party {
    ...
    private long advertisementStartTick;
    ...
    public long getAdvertisementStartTick() {
        return advertisementStartTick;
    }

    public void setAdvertisementStartTick(long advertisementStartTick) {
        this.advertisementStartTick = advertisementStartTick;
    }
    ...
    public void removeMember(Player player) {
        ...
        if (members.size() > 0 && player == leader) {
            ...
            updatePartyStage(leader, getRaid() == null ? WAITING : getRaid().getRaidStageConfig());
    ...
    public static void updatePartyStage(Player player, int stage) {
        ...
        if(player.raidsParty.getSize() > 1)
            stage |= player.raidsParty.getMembers().size() << 1;
