...
public class Clue {
    ...
    public boolean advance(Player player) {
        for(Item item : player.getInventory().getItems()) {
            ...
            /* Super Donator and above */
            if (save.remaining > 0 && player.isDonator() && !player.isGroup(PlayerGroup.DONATOR) && Random.get() < 0.20) {
                player.sendMessage("<col=1e44b3>Your donator status comes in handy and allows you to skip a step in this clue!");
                save.remaining--;
            }
