...
public class CrypticClue extends Clue {
    ...
    static {
        ...
        registerDig("Come to the evil ledge, Yew know yew want to. Try not to get stung.", 3094, 3499, 0, ClueType.HARD);
    ...
    static {
        ...
        registerSearch("Even the seers say this clue goes right over their heads.", 26635, 2707, 3488, 2, ClueType.ELITE);
        ...
        registerSearch("Search the boxes in the house near the south entrance to Varrock.", 5111, 3203, 3384, 0, ClueType.NORMAL);
        registerSearch("Search the boxes just outside the Armour shop in East Ardounge.", 361, 2654, 3299, 0, ClueType.NORMAL);
        registerSearch("Search the boxes of Falador's general store.", 24088, 2955, 3390, 0, ClueType.NORMAL);
        registerSearch("Search the bush at the digsite centre.", 2357, 3345, 3378, 0, ClueType.NORMAL);
        registerSearch("It seems to have reached the end of the line, and it's still empty.", 6045, 3041, 9820, 0, ClueType.HARD);
        registerSearch("Search for a crate in a building in Hemenster.", 357, 2636, 3453, 0, ClueType.NORMAL);
         registerSearch("Read 'How to breed scorpions.' By O.W.Thathurt.", 380, 2702, 3409, 1, ClueType.HARD);
        registerSearch("Search the chests in the Dwarven Mine.", 375, 3000, 9798, 0, ClueType.NORMAL);
        registerSearch("Search the chests upstairs in the Al Kharid Palace.", 375, 3301, 3169, 1, ClueType.NORMAL);
        registerSearch("Search the crate in the left-hand tower of Lumbridge Castle.", 357, 3228, 3212, 1, ClueType.NORMAL);
        registerSearch("Search for a crate in Varrock Castle.", 5113, 3224, 3492, 0, ClueType.NORMAL);
        registerSearch("Search for a crate on the ground floor of a house in Seers' Village.", 25775, 2699, 3470, 0, ClueType.NORMAL);
        registerSearch("Search the crate near a cart in Port Khazard.", 366, 2660, 3149, 0, ClueType.NORMAL);
        registerSearch("Search the crates near a cart in Varrock.", 5107, 3226, 3452, 0, ClueType.NORMAL);
        registerSearch("Search the crates in a house in Yanille that has a piano.", 357, 2598, 3105, 0, ClueType.NORMAL);
        registerSearch("Search the crates in Canifis.", 24344, 3509, 3497, 0, ClueType.NORMAL);
        registerSearch("Search the crates in Horvik's armoury.", 5106, 3228, 3433, 0, ClueType.NORMAL);
        registerSearch("Search the crates in the Dwarven mine.", 357, 3035, 9849, 0, ClueType.NORMAL);
        registerSearch("Search the crates in the guard house of the northern gate of East Ardougne.", 356, 2645, 3338, 0, ClueType.NORMAL);
        registerSearch("Search the crates in the outhouse of the long building in Taverley.", 357, 2914, 3433, 0, ClueType.NORMAL);
        registerSearch("Search the crates in the shed just north of East Ardougne.", 355, 2617, 3347, 0, ClueType.NORMAL);
        registerSearch("Search the crates in most north-western house in Al Kharid.", 358, 3289, 3202, 0, ClueType.NORMAL);
        registerSearch("Search the crates in the Port Sarim Fishing shop.", 9534, 3012, 3222, 0, ClueType.NORMAL);
        registerSearch("Search the crate in the Toad and Chicken pub.", 354, 2913, 3536, 0, ClueType.NORMAL);
        registerSearch("Search the drawers above Varrock's shops.", 7194, 3206, 3419, 1, ClueType.NORMAL);
        registerSearch("Search the drawers found upstairs in East Ardougne's houses.", 348, 2574, 3326, 1, ClueType.NORMAL);
        registerSearch("Search the drawers in a house in Draynor Village.", 350, 3097, 3277, 0, ClueType.NORMAL);
        registerSearch("Search the drawers in Catherby's Archery shop.", 350, 2825, 3442, 0, ClueType.NORMAL);
        registerSearch("Search the drawers in Falador's chain mail shop.", 348, 2969, 3311, 0, ClueType.NORMAL);
        registerSearch("Search the drawers in the ground floor of a shop in Yanille.", 350, 2570, 3085, 0, ClueType.NORMAL);
        registerSearch("Search the drawers in the house next to the Port Sarim mage shop.", 348, 3024, 3259, 0, ClueType.NORMAL);
        registerSearch("Search the drawers in the upstairs of a house in Catherby.", 350, 2809, 3451, 1, ClueType.NORMAL);
        registerSearch("Search the drawers in one of Gertrude's bedrooms.", 7194, 3156, 3406, 0, ClueType.NORMAL);
        registerSearch("Search the drawers of houses in Burthorpe.", 348, 2929, 3570, 0, ClueType.NORMAL);
        registerSearch("Search the drawers on the first floor of a building overlooking Ardougne's Market.", 352, 2657, 3322, 1, ClueType.NORMAL);
        registerSearch("Search the drawers upstairs in Falador's shield shop.", 348, 2971, 3386, 1, ClueType.NORMAL);
        registerSearch("Search the drawers upstairs of houses in eastern part of Falador.", 350, 3035, 3347, 1, ClueType.NORMAL);
        registerSearch("Search the drawers, upstairs in the bank to the East of Varrock.", 7194, 3250, 3420, 1, ClueType.NORMAL);
        registerSearch("Search through some drawers in the upstairs of a house in Rimmington.", 352, 2970, 3214, 1, ClueType.NORMAL);
        registerSearch("Search through some drawers found in Taverley's houses.", 350, 2894, 3418, 0, ClueType.NORMAL);
        registerSearch("Search the crates in East Ardougne's general store.", 357, 2615, 3291, 0, ClueType.NORMAL);
        registerSearch("Search the tents in the Imperial Guard camp in Burthorpe for some boxes.", 3686, 2885, 3540, 0, ClueType.NORMAL);
        registerSearch("Search the wheelbarrow in Rimmington mine.", 9625, 2978, 3239, 0, ClueType.NORMAL);
        registerSearch("Search through chests found in the upstairs of houses in eastern Falador.", 375, 3041, 3364, 1, ClueType.NORMAL);
        registerSearch("Search upstairs in the houses of Seers' Village for some drawers.", 25766, 2716, 3471, 1, ClueType.NORMAL);*/
    }
