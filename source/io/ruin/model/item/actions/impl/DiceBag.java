...
public class DiceBag {
    ...
    private static void roll(Player player, int sides) {
    ...
    static {
        ItemAction.registerInventory(DICE_BAG, "roll 4-sided", (player, item) -> roll(player, 4));
        ItemAction.registerInventory(DICE_BAG, "roll 12-sided", (player, item) -> roll(player, 12));
        ItemAction.registerInventory(DICE_BAG, "roll 100-sided", (player, item) -> roll(player, 100));
    }
}
