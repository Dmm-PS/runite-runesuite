...
public class TridentOfTheSeas {
    ...
    static {
        if (World.isEco())
            CHARGE_ITEMS = Arrays.asList(Rune.DEATH.toItem(1), Rune.CHAOS.toItem(1), Rune.FIRE.toItem(5), new Item(995, 250)); //250gp
        else
            CHARGE_ITEMS = Arrays.asList(Rune.DEATH.toItem(1), Rune.CHAOS.toItem(1), Rune.FIRE.toItem(5), new Item(13307, 1)); // 1bm
