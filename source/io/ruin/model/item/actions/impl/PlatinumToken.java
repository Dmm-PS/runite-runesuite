        ...
        player.dialogue(
                new OptionsDialogue("Exchange your coins for platinum tokens?",
                        new Option("Yes", () -> {
                            ...
                            player.dialogue(new ItemDialogue().two(1003, 3991, "The bank exchanges your coins for platinum tokens."));
                        }),
        ...
        player.dialogue(
                new OptionsDialogue("Exchange your platinum tokens for coins?",
                        new Option("Yes", () -> {
                            ...
                            player.dialogue(new ItemDialogue().two(1003, 3991, "The bank exchanges your platinum tokens for coins."));
                        }),
                        new Option("No", player::closeDialogue)
                )
        );
