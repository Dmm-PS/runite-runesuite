    ...
    public void equip(Item selectedItem) {
        ...
        if(selectedDef.equipReqs != null) {
            for(int req : selectedDef.equipReqs) {
                ...
                if(stat.fixedLevel < lvl && !(World.isPVP() && statId > 6)) {
        ...
        if(World.isEco() && selectedDef.achievement != null && !selectedDef.achievement.isFinished(player) && (!selectedDef.achievementReqIsIronmanOnly || player.getGameMode().isIronMan())) {
