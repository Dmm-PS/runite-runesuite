...
public class PresetCustom extends Preset {
    ...
    public static final PresetCustom[] ENTRIES = {
            ...
            new PresetCustom(4),
            new PresetCustom(5),
            new PresetCustom(6, PlayerGroup.DONATOR, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(7, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(8, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(9, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(10, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(11, PlayerGroup.GODLIKE_DONATOR),
    };

    public static final PresetCustom[] ECO_ENTRIES = {
            new PresetCustom(1, PlayerGroup.DONATOR, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(2, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(3, PlayerGroup.EXTREME_DONATOR, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(4, PlayerGroup.LEGENDARY_DONATOR, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(5, PlayerGroup.UBER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(6, PlayerGroup.GODLIKE_DONATOR),
    };

    public static PresetCustom[] getEntries() {
        return World.isEco() ? ECO_ENTRIES : ENTRIES;
    }
