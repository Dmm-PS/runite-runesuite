...
public class PureNoHonorTribrid extends Preset {
    ...
    public PureNoHonorTribrid() {
        ...
        invItems[6] = new Item(DRAGON_DAGGER, 1);
        ...
        equipItems[Equipment.SLOT_AMMO] = new Item(RUNITE_BOLT, 50);
        ...
        equipItems[Equipment.SLOT_LEGS] = new Item(ZAMORAK_ROBE_SKIRT, 1);
        equipItems[Equipment.SLOT_CAPE] = new Item(ZAMORAK_CAPE, 1);
        equipItems[Equipment.SLOT_CHEST] = new Item(ZAMORAK_ROBE_TOP, 1);
        equipItems[Equipment.SLOT_HAT] = new Item(BLACK_WIZARD_HAT, 1);
