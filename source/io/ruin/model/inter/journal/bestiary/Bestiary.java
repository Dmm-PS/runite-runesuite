...
public class Bestiary {
    ...
    public static void search(Player player, String name, boolean monster) {
        ...
        TaskWorker.startTask(t -> {
            ...
            //^ kind of lame we have to re-add these but whatever.
            ...
            if(!search.isEmpty()) {
                ...
                int[] childId = {2}; //0 & 1 are already set from search entries.
                map.values().forEach(levelsMap -> {
                    ...
                    for(NPCDef def : matched) {
                        ...
                        result.childId = childId[0]++; //wish java somehow allowed non-final modification inside of lambdas!
