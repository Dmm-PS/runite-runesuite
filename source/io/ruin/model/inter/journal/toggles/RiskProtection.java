...
public class RiskProtection extends JournalEntry {
        ...
        player.dialogue(new OptionsDialogue(
                new Option("Toggle Risk Protection", () -> {
                    ...
                    player.dialogue(new OptionsDialogue("What level of risk protection would you like?",
                            new Option("10,000+ BM", () -> toggleRiskProtection(player, 1)),
                            new Option("25,000+ BM", () -> toggleRiskProtection(player, 2)),
                            new Option("50,000+ BM", () -> toggleRiskProtection(player, 3))
                    ));
                }),
    ...
    private static void toggleRiskProtection(Player player, int tier) {
        ...
        player.sendMessage(Color.DARK_RED.wrap("You now have a risk protection value up to " + NumberUtils.formatNumber(protectionValue(player)) + " Blood money."));
    ...
    private String protectionState(Player player) {
        ...
        else return NumberUtils.formatNumber(protectionValue(player)) + "+ BM";
    }
