...
public class BuyCredits {
    ...
    TODO: This was an experimental system created to basically allow players to purchase
    credits from the store through in-game. however, there was an issue accessing cookies
    through java applet -> google chrome/default browser. if you're interested in this we'll
