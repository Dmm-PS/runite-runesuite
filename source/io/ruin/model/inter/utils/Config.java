...
public class Config {
    ...
    public static final Config LMS_IN_GAME = varpbit(5314, false);
    public static final Config LMS_SAFE_X = varpbit(5316, false);
    public static final Config LMS_SAFE_Y = varpbit(5320, false);
    public static final Config LMS_POISON_PROGRESS = varpbit(5317, false);
    public static final Config LMS_KILLS = varpbit(5315, false);
    public static final Config FOG_LEVEL = varpbit(5319, false);
    ...
    public static final Config BRIGHTNESS = varp(166, true).defaultValue(2);
    ...
    public static final Config RUNNING = varp(173, true);
