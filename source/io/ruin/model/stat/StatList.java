...
public class StatList {
    ...
    public void addXp(StatType type, double amount, boolean useMultiplier) {
        ...
        if (World.isPVP() && type.defaultXpMultiplier == -1) {
            ...
            if (type.defaultXpMultiplier == -1) { // Combat
                if (player.combatXpRate == 0) {
                    return;
                }
                if (useMultiplier) {
                ...
                if (useMultiplier) {
                    if (stat.fixedLevel >= 99) {
                        ...
                        if (player.isClassicMode()) {
                            amount *= 5;
                        } else {
                            amount *= type.defaultXpMultiplier * 4;
                        }
                    }
                }
            }
    ...
    public void process() {
        ...
        boolean rapidHeal = player.getPrayer().isActive(Prayer.RAPID_HEAL);
