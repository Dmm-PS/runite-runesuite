...
public abstract class Patch {
    ...
    public void plant(Item item) {
        ...
        player.startEvent(event -> {
            ...
            if (player.isGroup(PlayerGroup.UBER_DONATOR) || player.isGroup(PlayerGroup.GODLIKE_DONATOR)) {
                setCompost(2);
            } else if (player.isGroup(PlayerGroup.LEGENDARY_DONATOR) || player.isGroup(PlayerGroup.EXTREME_DONATOR)) {
                setCompost(1);
            }
