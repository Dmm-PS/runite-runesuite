...
public enum WoodTreeCrop implements TreeCrop {
	OAK(5312, 6043, 5370, 5358, 5364, Tree.OAK, 15, 14, 467.3, 4, new Item(995,  4000), 8, PlayerCounter.GROWN_OAK),
	WILLOW(5313, 6045, 5371, 5359, 5365, Tree.WILLOW, 30, 25, 1456.5, 6, new Item(995,  8000), 15, PlayerCounter.GROWN_WILLOW),
	MAPLE(5314, 6047, 5372, 5360, 5366, Tree.MAPLE, 45, 45, 3403.4, 8, new Item(995,  20000), 24, PlayerCounter.GROWN_MAPLE),
	YEW(5315, 6049, 5373, 5361, 5367, Tree.YEW, 60, 81, 7069, 10, new Item(995,  70000), 35, PlayerCounter.GROWN_YEW),
	MAGIC(5316,  6051, 5374, 5362, 5368, Tree.MAGIC, 75, 145.5, 13768.3, 12, new Item(995,  120000), 48, PlayerCounter.GROWN_MAGIC);
