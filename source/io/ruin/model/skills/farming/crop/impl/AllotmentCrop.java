...
public enum AllotmentCrop implements Crop {
	POTATO(5318, 1942, 1, 8, 9, 4, FlowerCrop.MARIGOLDS, new Item(995,  50), 6, PlayerCounter.HARVESTED_POTATO),
	ONION(5319, 1957, 5, 9.5, 10.5, 4, FlowerCrop.MARIGOLDS, new Item(995,  100), 13, PlayerCounter.HARVESTED_ONION),
	CABBAGE(5324, 1965, 7, 10, 11.5, 4, FlowerCrop.ROSEMARY, new Item(995,  200), 20, PlayerCounter.HARVESTED_CABBAGE),
	TOMATO(5322, 1982, 12, 12.5, 14, 4, FlowerCrop.MARIGOLDS, new Item(995,  300), 27, PlayerCounter.HARVESTED_TOMATO),
	SWEETCORN(5320, 5986, 20, 17, 19, 6, null, new Item(995,  500), 34, PlayerCounter.HARVESTED_SWEETCORN),
	STRAWBERRY(5323, 5504, 31, 26, 29, 6, null, new Item(995,  800), 43, PlayerCounter.HARVESTED_STRAWBERRY),
	WATERMELON(5321, 5982, 47, 48.5, 54.5, 8, FlowerCrop.NASTURTIUM, new Item(995,  5000), 52, PlayerCounter.HARVESTED_WATERMELON);
