...
public class AlKharidCourse {
    ...
    static {
         ...
         * Wall climb
         */
        ObjectAction.register(10093, "climb", (p, obj) -> p.startEvent(e -> {
         ...
         * Tightrope
         */
        ObjectAction.register(10284, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Cable swing
         */
        ObjectAction.register(10355, "swing-across", (p, obj) -> p.startEvent(e -> {
           p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Teeth swing
         */
        ObjectAction.register(10356, "teeth-grip", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 10);
            e.delay(1);
            p.privateSound(1933);
         ...
         * Palm tree swing
         */
        ObjectAction.register(10357, "swing-across", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
        ...
        Tile.getObject(10357, 3318, 3166, 1).walkTo = new Position(3318, 3165, 1);

        /**
         * Wall climb
         */
        ObjectAction.register(10094, "climb", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(828, 15);
            e.delay(2);
         ...
         *  Last tightrope
         */
        ObjectAction.register(10583, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
        ...
        Tile.getObject(10583, 3313, 3186, 3).walkTo = new Position(3314, 3186, 3);
        /**
         *  Jump down
         */
        ObjectAction.register(10352, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586);
            e.delay(1);
