...
public class CanifisCourse {
    ...
    static {
         ...
         * Tall tree
         */
        ObjectAction.register(10819, "climb", (player, obj) -> player.startEvent(event -> {
            if (!player.getStats().check(StatType.Agility, 40, "attempt this"))
                return;
            if(World.isPVP()) {
                player.sendMessage("You can only train agility at the Wilderness Course.");
                return;
            }
        ...
        Tile.getObject(10819, 3505, 3489, 0).walkTo = new Position(3507, 3488, 0);
        Tile.get(3505, 3492, 2, true).flagUnmovable();
        /**
         * Jump gap
         */
        ObjectAction.register(10820, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Jump gap
         */
        ObjectAction.register(10821, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Jump gap
         */
        ObjectAction.register(10828, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Jump gap
         */
        ObjectAction.register(10822, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Vault
         */
        ObjectAction.register(10831, "vault", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Jump gap
         */
        ObjectAction.register(10823, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Jump gap
         */
        ObjectAction.register(10832, "jump", (player, obj) -> player.startEvent(event -> {
            player.lock(LockType.FULL_DELAY_DAMAGE);
            player.privateSound(2462, 1, 15);
            player.animate(2586, 15);
            event.delay(1);
