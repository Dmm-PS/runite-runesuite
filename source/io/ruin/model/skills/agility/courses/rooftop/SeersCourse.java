...
public class SeersCourse {
    ...
    static {
         ...
         * Wall climb
         */
        ObjectAction.register(11373, "climb-up", (p, obj) -> p.startEvent(e -> {
         ...
         * Rooftop jump
         */
        ObjectAction.register(11374, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Tightrope
         */
        ObjectAction.register(11378, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(11375, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Small gap
         */
        ObjectAction.register(11376, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
         ...
         * Final jump
         */
        ObjectAction.register(11377, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2462, 15);
