...
public class FaladorCourse {
    ...
    static {
         ...
         * Wall climb
         */
        ObjectAction.register(10833, "climb", (p, obj) -> p.startEvent(e -> {
            if (!p.getStats().check(StatType.Agility, 50, "attempt this"))
                return;
            if(World.isPVP()) {
                p.sendMessage("You can only train agility at the Wilderness Course.");
                return;
            }
         ...
         * Tightrope
         */
        ObjectAction.register(10834, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Wall bricks
         */
        ObjectAction.register(10836, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(11161, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(741);
        ...
        Tile.getObject(11161, 3048, 3359, 3).walkTo = new Position(3048, 3358, 3);
        /**
         * Gap
         */
        ObjectAction.register(11360, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(741);
       ...
       Tile.getObject(11360, 3044, 3361, 3).walkTo = new Position(3045, 3361, 3);
        /**
         * Tightrope
         */
        ObjectAction.register(11361, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.getAppearance().setCustomRenders(Renders.AGILITY_BALANCE);
         ...
         * Tightrope
         */
        ObjectAction.register(11364, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(11365, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.privateSound(2461);
            p.animate(1603);
        ...
        Tile.getObject(11365, 3016, 3352, 3).walkTo = new Position(3016, 3353, 3);
        /**
         * Gap
         */
        ObjectAction.register(11366, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock();
            p.privateSound(2461);
            p.animate(1603);
         ...
         * Gap
         */
        ObjectAction.register(11367, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.privateSound(2461);
            p.animate(1603);
         ...
         * Gap
         */
        ObjectAction.register(11368, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.privateSound(2461);
            p.animate(1603);
            p.getMovement().force(0, -2, 0, 0, 15, 30, Direction.SOUTH);
         ...
         * Gap
         */
        ObjectAction.register(11370, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.privateSound(2461);
            p.animate(1603);
         ...
         * Gap
         */
        ObjectAction.register(11371, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.privateSound(2461);
            p.animate(1603);
