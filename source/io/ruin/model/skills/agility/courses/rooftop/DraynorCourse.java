...
public class DraynorCourse {
    ...
    static {
         ...
         * Rough wall
         */
        ObjectAction.register(10073, "climb", (p, obj) -> p.startEvent(e -> {
         ...
         * Tightrope
         */
        ObjectAction.register(10074, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Tightrope
         */
        ObjectAction.register(10075, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Narrow wall
         */
        ObjectAction.register(10077, "balance", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(753);
         ...
         * Wall
         */
        ObjectAction.register(10084, "jump-up", (p, obj) -> p.startEvent(e -> { //TODO: fix this
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(10085, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
            e.delay(1);
         ...
         * Crate jump
         */
        ObjectAction.register(10086, "climb-down", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
            e.delay(1);
