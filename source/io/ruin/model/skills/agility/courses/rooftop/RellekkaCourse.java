...
public class RellekkaCourse {
    ...
    static {
         ...
         * Rough wall
         */
        ObjectAction.register(11391, "climb", (p, obj) -> p.startEvent(e -> {
         ...
         * Gap
         */
        ObjectAction.register(11392, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(1995, 15);
            e.delay(1);
            p.privateSound(1936);
         ...
         * Tightrope
         */
        ObjectAction.register(11393, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap + tightrope
         */
        ObjectAction.register(11395, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(11396, "hurdle", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(1995, 15);
            e.delay(1);
            p.privateSound(1936);
         ...
         * Tightrope
         */
        ObjectAction.register(11397, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Pile of fish
         */
        ObjectAction.register(11404, "jump-in", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
