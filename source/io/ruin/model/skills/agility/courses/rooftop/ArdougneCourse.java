...
public class ArdougneCourse {
    ...
    static {
         ...
         * Wall climb
         */
        ObjectAction.register(11405, "climb-up", (p, obj) -> p.startEvent(e -> {
         ...
         * Jump down roof
         */
        ObjectAction.register(11406, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
         ...
         * Plank
         */
        ObjectAction.register(11631, "walk-on", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(11429, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
            p.privateSound(2462, 0, 15);
            e.delay(1);
         ...
         * Gap
         */
        ObjectAction.register(11430, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(7133, 15);
            p.privateSound(2462, 0, 15);
            e.delay(1);
         ...
         * Steep roof
         */
        ObjectAction.register(11633, "balance-across", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(753);
         ...
         * Gap
         */
        ObjectAction.register(11630, "jump", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(2586, 15);
            p.privateSound(2462, 0, 15);
            e.delay(1);
