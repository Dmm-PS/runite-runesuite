...
public class VarrockCourse {
    ...
    static {
         ...
         * Rough wall
         */
        ObjectAction.register(10586, "climb", (p, obj) -> p.startEvent(e -> {
         ...
         * Clothes line
         */
        ObjectAction.register(10587, "cross", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Gap
         */
        ObjectAction.register(10642, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Wall
         */
        ObjectAction.register(10777, "balance", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
        ...
        Tile.getObject(10777, 3191, 3415, 1).walkTo = new Position(3194, 3416, 0);
        /**
         * Gap
         */
        ObjectAction.register(10778, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            e.delay(1);
            p.privateSound(2468, 0, 20);
            p.animate(2583, 10);
         ...
         * Gap
         */
        ObjectAction.register(10779, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(1995);
            p.privateSound(2461, 0, 15);
            p.animate(4789, 15);
         ...
         * Gap
         */
        ObjectAction.register(10780, "leap", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Ledge
         */
        ObjectAction.register(10781, "hurdle", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
         ...
         * Edge
         */
        ObjectAction.register(10817, "jump-off", (p, obj) -> p.startEvent(e -> {
            p.lock(LockType.FULL_DELAY_DAMAGE);
            p.animate(741);
