...
public class BotPrevention {
    ...
    public static void spawn(Player player) {
        ...
        player.sendMessage(Color.COOL_BLUE.wrap("A guard has suspicion you've been stealing from Runite."));
        ...
        npc.addEvent(e -> {
            while (player.isOnline()) {
                ...
                if(player.dismissBotPreventionNPC) {
                    ...
                    player.getInventory().addOrDrop(995, randomGold);
    ...
    static {
        NPCAction.register(PILLORY_GUARD, "talk-to", (player, npc) -> {
            if(npc.ownerId != player.getUserId()) {
                ...
                player.dialogue(new NPCDialogue(PILLORY_GUARD, "I've gotten reports that you've been stealing from Runite, "
