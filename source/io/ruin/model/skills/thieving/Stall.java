...
import io.ruin.model.item.actions.impl.BloodMoneyPouch;
...
public enum Stall {
    ...
    VEGETABLE_STALL(2, 2, 10.0, 52000, "vegetable stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 400, 500, 12) //Coins
            )),
    BAKERS_STALL(1, 2, 16.0, 49000, "baker's stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 500, 800, 3) //Coins
            )),
    CRAFTING_STALL(5, 7, 16.0, 49000, "crafting stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 400, 800, 3) //Coins
            )),
    MONKEY_FOOD_STALL(5, 7, 16.0, 49000, "food stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 400, 800, 2) //Coins
            )),
    MONKEY_GENERAL_STALL(5, 7, 16.0, 49000, "general stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 400, 800, 4) //Coins
            )),
    ...
    SILK_STALL(20, 2, 24.0, 42000, "silk stall",
            ...
            null,
            new LootTable().addTable(1,
            new LootItem(950, 1, 8),                     //Silk
            new LootItem(950, 1, 9),                     //Silk
            new LootItem(950, 1, 10),                     //Silk
            new LootItem(995, 400, 1000, 1) //Coins
            )),
    WINE_STALL(22, 3, 27.0, 41000, "wine stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 600, 1200, 4) //Coins
            )),
    SEED_STALL(27, 3, 10.0, 40000, "seed stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 3000, 60) //Coins
            )),
    FUR_STALL(35, 5, 36.0, 22000, "fur stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 4000, 5) //Coins
            )),
    FISH_STALL(42, 5, 42.0, 21000, "fish stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2200, 4400, 12) //Coins
            )),
    CROSSBOW_STALL(49, 5, 52.0, 20000, "crossbow stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2500,5000, 14) //Coins
            )),
    SILVER_STALL(50, 5, 54.0, 19000, "silver stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 3200, 2)               //Coins
            )),
    SPICE_STALL(65, 5, 81.0, 13000, "spice stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 7000, 4)  //Coins
            )),
    MAGIC_STALL(65, 7, 100, 12000, "magic stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 5000, 10) //Coins
            )),
    SCIMITAR_STALL(65, 7, 100.0, 1000, "scimitar stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 4000, 6000, 2) //Coins
            )),
    GEM_STALL(75, 10, 160.0, 8500, "gem stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2000, 5000, 2) //Coins
            )),
    MOR_GEM_STALL(75, 10, 160.0, 8500, "gem stall",
            ...
            new LootTable().addTable(1,
                    ...
                    new LootItem(995, 2500, 5000, 3) //Coins
            )),
    ...
    private static void attempt(Player player, Stall stall, GameObject object, int replacementID) {
        ...
        if(World.isPVP() && player.wildernessLevel == 0) {
            player.privateSound(2277);
            player.dialogue(new MessageDialogue("Thieving can only be trained inside the wilderness!"));
            return;
        }

        if(World.isPVP() && player.getInventory().count(stall.bloodMoneyReward.getId()) >= BloodMoneyPouch.MAX_ALLOWED) {
            player.privateSound(2277);
        ...
        if(World.isPVP() && player.getCombat().getLevel() != 126) {
            player.sendMessage("You need a combat level of 126 in order to thieve from these stalls!");
            return;
        }
        ...
        if(World.isEco() && BotPrevention.isBlocked(player)) {
        ...
        player.startEvent(event -> {
            ...
            if(World.isPVP()) {
                player.getInventory().add(stall.bloodMoneyReward);
            } else {
