...
public enum Prayer {
    ...
    PROTECT_FROM_MAGIC(4116, 2675, p -> {
        ...
        p.activationCheck = player ->  {
            ...
            if(player.joinedTournament && !Tournament.schedule.preset.overheadsAllowed) {
                player.sendMessage("You can't use protection prayers in this tournament.");
                return false;
            }
            return true;
        };
    ...
    RIGOUR(5464, 2685, p -> {
        ...
        p.activationCheck = player -> {
            ...
            if (player.joinedTournament) {
                player.sendMessage("You can't use Rigour in tournaments.");
                return false;
            }
            return true;
        };
    ...
    AUGURY(5465, 2670, p -> {
        ...
        p.activationCheck = player -> {
            ...
            if (player.joinedTournament) {
                player.sendMessage("You can't use Augury in tournaments.");
                return false;
            }
            return true;
        };
