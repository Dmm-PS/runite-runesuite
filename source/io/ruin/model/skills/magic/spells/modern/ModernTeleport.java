...
public class ModernTeleport extends Spell {
    ...
    public static final ModernTeleport VARROCK_TELEPORT = new ModernTeleport(25, 35.0, new Bounds(3211, 3422, 3214, 3424, 0), Rune.LAW.toItem(1), Rune.AIR.toItem(3), Rune.FIRE.toItem(1));
    ...
    public static final ModernTeleport CAMELOT_TELEPORT = new ModernTeleport(45, 55.5, new Bounds(2756, 3476, 2759, 3480, 0), Rune.LAW.toItem(1), Rune.AIR.toItem(5));
    ...
    public static final ModernTeleport WATCHTOWER_TELEPORT = new ModernTeleport(58, 68.0, new Bounds(2546, 3112, 2547, 3113, 2), Rune.LAW.toItem(2), Rune.EARTH.toItem(2));
    ...
    public ModernTeleport(int lvlReq, double xp, Bounds bounds, Item... runes) {
        ...
        this.xp = xp;
        this.runes = runes;
        registerClick(lvlReq, xp, true, runes, p -> teleport(p, bounds));
    }
    ...
    public ModernTeleport(int lvlReq, double xp, int x, int y, int z, Item... runes) {
        ...
        this.xp = xp;
        this.runes = runes;
        registerClick(lvlReq, xp, true, runes, p -> teleport(p, x, y, z));
    }
