...
public class Mining {
    ...
    private static void mine(Rock rockData, Player player, GameObject rock, int emptyId, PlayerCounter counter) {
        ...
        if(World.isPVP()) {
            player.sendMessage("Mining is currently disabled on the PVP world");
            return;
        }
        if (pickaxe == null) {
        ...
        player.startEvent(event -> {
            ...
            while (true) {
                ...
                if(attempts == 0) {
                    ...
                    player.sendMessage("You manage to mine " + (rockData == Rock.GEM_ROCK ? "a " : "some ") +
...
//                player.getInventory().add(2362, 1);
    ...
    static {
        Object[][] oreData = {
                //rock, baseId, emptyId
                {Rock.CLAY, 7487, 7468, PlayerCounter.MINED_CLAY},
                {Rock.CLAY, 7454, 7469, PlayerCounter.MINED_COPPER},
                {Rock.COPPER, 7453, 7468, PlayerCounter.MINED_COPPER},
                {Rock.COPPER, 7484, 7469, PlayerCounter.MINED_COPPER},
                {Rock.IRON, 7455, 7468, PlayerCounter.MINED_IRON},
                {Rock.IRON, 7488, 7469, PlayerCounter.MINED_IRON},
                {Rock.TIN, 7485, 7468, PlayerCounter.MINED_TIN},
                {Rock.TIN, 7486, 7469, PlayerCounter.MINED_TIN},
                {Rock.COAL, 7456, 7469, PlayerCounter.MINED_COAL},
                {Rock.COAL, 7489, 7468, PlayerCounter.MINED_COAL},
                {Rock.SILVER, 7457, 7468, PlayerCounter.MINED_SILVER},
                {Rock.SILVER, 7490, 7469, PlayerCounter.MINED_SILVER},
                {Rock.GOLD, 7491, 7468, PlayerCounter.MINED_GOLD},
                {Rock.GOLD, 7458, 7469, PlayerCounter.MINED_GOLD},
                {Rock.MITHRIL, 7459, 7468, PlayerCounter.MINED_MITHRIL},
                {Rock.MITHRIL, 7492, 7469, PlayerCounter.MINED_MITHRIL},
                {Rock.LOVAKITE, 28596, 7468, PlayerCounter.MINED_LOVAKITE},
                {Rock.LOVAKITE, 28597, 7469, PlayerCounter.MINED_LOVAKITE},
                {Rock.ADAMANT, 7493, 7468, PlayerCounter.MINED_ADAMANT},
                {Rock.ADAMANT, 7460, 7469, PlayerCounter.MINED_ADAMANT},
                {Rock.RUNE, 7461, 7468, PlayerCounter.MINED_RUNITE},
                {Rock.RUNE, 7494, 7469, PlayerCounter.MINED_RUNITE},
                {Rock.SANDSTONE, 8727, 7468, PlayerCounter.MINED_SANDSTONE},
                {Rock.GRANITE, 7467, 7469, PlayerCounter.MINED_GRANITE}
        };
         ...
         */
        Object[][] gemRock = {
                {Rock.GEM_ROCK, 7463, 7468, PlayerCounter.MINED_GEM_ROCK},
                {Rock.GEM_ROCK, 7464, 7469, PlayerCounter.MINED_GEM_ROCK}
        };
