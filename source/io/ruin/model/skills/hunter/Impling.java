...
public enum Impling {
    ...
    NINJA(1643, 75, 85, 50, 60, 11254, 40, 10),
    ...
    private static final int PURO_PURO_RANDOM_SPAWN_DELAY = 100; // respawn time for random spawns in puro puro (other implings)
