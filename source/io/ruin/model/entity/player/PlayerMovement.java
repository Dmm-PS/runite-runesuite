...
public class PlayerMovement extends Movement {
    ...
    public boolean startTeleport(int maxWildernessLevel, EventConsumer eventConsumer) {
        ...
        player.lock(LockType.FULL_NULLIFY_DAMAGE); //keep lock outside of event! (in case event is triggered by another event, which will most likely delay the player event to the next tick...)
        player.addEvent(event -> { //"add" to be safe this even is never overwritten
