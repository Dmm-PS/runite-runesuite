...
import io.ruin.model.activities.tournament.TournamentPreset;
...
public abstract class PlayerAttributes extends Entity {
    ...
    @Expose public int combatXpRate = World.isEco() ? 150 : 250;
     ...
     * Overload
     */
    @Expose public int overloadFlatBoost;
    @Expose public double overloadPercentBoost;
    @Expose public int overloadTicks;

    /**
     * Prayer enhance
     */
    @Expose public int prayerEnhanceTicks;
    @Expose public int prayerEnhanceFrequency;
     ...
     */
    public boolean tournamentPrayerDisabled = false;
    ...
    public TournamentPreset tournamentPreset;
    public TickDelay tournamentCooldown = new TickDelay();
    public int tournamentKills = 0;
    public int tournamentRound = 0;
    public boolean canAttackTournamentTarget = false;
    public boolean usingTournamentOrb = false;
    public boolean usingTournamentOrbFromHome = false;
    public boolean wonRound = false;
    public long tournamentFightStarted = 0;
    ...
    @Expose public int partyRejoinId = -1;
    ...
    public boolean claimedSuperMBoxReward = true;
    ...
    @Expose public int pestControlParticipation = 0;
    @Expose public int voidKnightCommendationPoints = 0;
