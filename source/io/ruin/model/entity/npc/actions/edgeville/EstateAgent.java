...
public class EstateAgent {
                                        ...
                                        new OptionsDialogue("Purchase a house for " + Color.COOL_BLUE.wrap(NumberUtils.formatNumber(HOUSE_COST)) + " coins?",
                                                new Option("Yes please!", () -> {
                                                    player.dialogue(new PlayerDialogue("Yes please!"),
                                                            new ActionDialogue(() -> {
                                                                if (player.getInventory().contains(995, HOUSE_COST)) {
                                                                    player.getInventory().remove(995, HOUSE_COST);
    ...
    private static void moveHouse(Player player, HouseLocation newLocation) {
        ...
        if (!player.getInventory().contains(995, newLocation.getCost())) {
        ...
        player.getInventory().remove(995, newLocation.getCost());
    ...
    private static void redecorate(Player player, HouseStyle newStyle) {
        ...
        if (!player.getInventory().contains(995, newStyle.cost)) {
        ...
        player.getInventory().remove(995, newStyle.cost);
