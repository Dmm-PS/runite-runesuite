...
public class Adam {
    ...
    static {
        NPCAction.register(ADAM, "Talk-to", (player, npc) -> {
            if (player.getGameMode().isIronMan()) {
                player.dialogue(new NPCDialogue(npc, "Hello " + player.getName() + ", how can I help you today?"),
                        new OptionsDialogue(
                                new Option("View Shop", () -> {
                                    if(World.isPVP())
                                        npc.getDef().shop.open(player);
                                    else
                                        player.dialogue(new NPCDialogue(npc, "You can view the Ironman shop by trading Sigmund adjacent to me!"));
                                }),
        ...
        NPCAction.register(ADAM, "Armour", ((player, npc) ->  {
            player.dialogue(new OptionsDialogue("Collect a set of the Ironman Armour?",
