...
public class Grace {
    static {
        NPCAction.register(5919, "talk-to", (player, npc) -> {
            player.dialogue(new NPCDialogue(npc, "Hello, " + player.getName() + ". Would you like to see the mark exchange, or learn more about marks of grace?"),
                    new OptionsDialogue(
