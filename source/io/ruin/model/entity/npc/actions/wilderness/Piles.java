...
public enum Piles {
    ...
    public static final int EXCHANGE_RATE = World.isPVP() ? 5 : 50;

    private static void talk(Player player, NPC npc) {
        String currencyName = World.isPVP() ? "5 blood money" : "50 coins";
        player.dialogue(
    ...
    static {
        ...
        ItemNPCAction.register("piles", (player, item, npc) -> {
            if(item != null && item.getDef().allowPilesToNote) {
                ...
                String currencyName = World.isPVP() ? "blood money" : "gold coins";
