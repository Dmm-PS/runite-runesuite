...
public class teleports implements DataFile {
    ...
    private static void teleportStart(Player player, int x, int y, int z, int price) {
        ...
        player.unsafeDialogue(new YesNoDialogue("Are you sure you want to use this teleport?", "This teleport will cost " + price + " blood money.", 13307, price, () -> {
            Item bloodMoneyInventory = player.getInventory().findItem(13307);
            ...
            Item bloodMoneyBank = player.getBank().findItem(13307);
