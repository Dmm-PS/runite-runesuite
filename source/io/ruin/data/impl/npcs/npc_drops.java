...
public class npc_drops implements DataFile {
    ...
    public Object fromJson(String fileName, String json) {
        ...
        for(DropTable t : tables) {
            t.calculateWeight();
            if(t.guaranteed == null && t.totalWeight == 0 && World.debug) {
    ...
    private static final class WikiDumper {
        ...
        public DumpTable run() {
            try {
                ...
                System.err.println("Error while parsing: " + wikiName);
                e.printStackTrace();
                return null;
            }
        }
        ...
        private List<DumpItem> parse(String tableName, String item, String quantity, Element rarity) {
            try {
                ...
                System.err.println("Error parsing wiki (" + wikiName + ") table entry! | table=" + tableName + "   item=" + item + "   quantity=" + quantity + "   rarity=" + rarity);
                e.printStackTrace();
                return null;
            }
        }
