...
public interface DataFile {
    ...
    static void loadUnpacked() throws Exception {
    ...
    static void loadPacked() throws Exception {
        System.err.println("Data folder does not exist, attempting to load packed data...");
        File packedFile = Server.getFile("server-data.json");
    ...
    static List<PackedFile> load(DataFile dataFile) throws Exception {
        ...
        for(File unpackedFile : unpackedFiles) {
            ...
            try {
                ...
                System.err.println(unpackedFile.getAbsolutePath());
                t.printStackTrace();
            }
        }
        return packedFiles;
    ...
    static void reload(Player player, Class<? extends DataFile> c) {
        ...
        try {
            ...
            e.printStackTrace();
            player.sendMessage("Failed to reload data files for class \"" + name + "\" !");
        }
    }
    ...
    final class PackedFile {
        ...
        void load() {
            try {
                ...
                System.err.println("Failed to load packed data file! class=" + loaderClass + " error=" + e.getMessage());
                e.printStackTrace();
            }
        }
